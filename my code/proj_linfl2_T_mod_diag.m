...
% Modified projection onto the l_infinity l_2 ball
%
% Author: Carlos Fernandez-Granda
% Email: cfgranda@stanford.edu

function op = proj_linfl2_T_mod_diag( param )
...
switch nargin,
    ...
    case 3,
        x = x ./ repmat(max( 1, abs( aux / q ) ),n1,1);
%        pow = 0.3; %THIS IS THE POWER TO WHICH I RAISE X
